-- Global Constants
FanOnTemp = 180  -- Temperature in F that the fan should be on
FanMaxSpeed = 45 -- Above this speed the fan will not operate

FuelPullUp = 1100 -- The value of the resistor in the divider circuit for fuel level

OverRevRPM = 7600  -- Any RPM value above this value will be considered an over rev

first = 4.20  -- transmission ratio for 1st gear
second = 2.49  -- transmission ratio for 2nd gear
third = 1.66  -- transmission ratio for 3rd gear
fourth = 1.24  -- transmission ratio for 4th gear
fifth = 1.00  -- transmission ratio for 5th gear
final = 3.73  -- final drive ratio
tirediameter = 24.8 -- The diamater in inches of the driven tire

OilPWarn = 20  --  Minimum oil pressure to trigger warning in PSI when TPS is more than 50 percent
OilIdleWarn = 6 --  Minimum oil pressure to trigger warning in PSI at idle
OilTWarn = 275  --  Maximum oil temperature to trigger warning in F
WaterTWarn = 240  --  Maximum water temperature to trigger warning in F

ShiftLightGrn = 5000 -- power band begins
ShiftLightYel = 6800 -- yellow aproaching redline
ShiftlightRed = 7100 -- Red line
FuelRed = 1 -- number of gallons remaining when the warning light flashes red

tickRate=10  -- rate in Hz that the main function executes
...
sxBright=0 --Brightness, 0-100. 0=automatic brightness

-- Global Variables
rpm = 0  --  variable for tracking engine RPM
rpm_diff = 0  -- variable for tracking the RPM of the differential
speed = 0  -- variable for tracking differential speed in MPH
...
function RevCheck()
 ...
 if rpm > OverRevRPM then  setChannel(overRevId, 1) end
...
-- only update fuel average if G are less than .5 in any direction
  if LowAcc == 1 then 
...
function sxOnInit()
  ...
  sxSetLinearThresh(1,0,ShiftLightYel,255,255,0,0) --yellow 
  sxSetLinearThresh(2,0,ShiftlightRed,255,0,0,10) --red+flash 
